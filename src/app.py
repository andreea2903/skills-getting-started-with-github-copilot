...
activities = {
    ...
    "Swimming Club": {
        "description": "Swim technique practice and water fitness sessions",
    ...
    "Drama Club": {
        "description": "Acting workshops and stage performance rehearsals",
    ...
    "Book Club": {
        "description": "Read and discuss books across genres each month",
